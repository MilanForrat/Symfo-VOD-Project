...
use EasyCorp\Bundle\EasyAdminBundle\Field\{IdField, EmailField, TextField, ArrayField, CollectionField,AssociationField, ChoiceField, DateTimeField};
...
class UserCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        $fields = [
            ...
            DateTimeField::new('lastLoginAt', 'Date de dernière connexion')->onlyOnIndex(),
